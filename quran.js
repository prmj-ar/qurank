...
//programmed by  @RGMY.ME  / https//instagrma.com/rgmy.me 
...
$.each(ayat['quran'],function( i ,v) {
    ...
    aya_number = v['aya'] // sura name

    // ayat of sura in "text" key 
    sura_text += v['text'].replace('بِسْمِ ٱللَّهِ ٱلرَّحْمَـٰنِ ٱلرَّحِيمِ','')+' {'+(aya_number)+'} ';// we gonna remove it cuz we need it in top of screen and we dont wanna cut it from text just we will remove it and re insert it
    }
});
